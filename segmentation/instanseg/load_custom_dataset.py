...
def load_custom_dataset(
    ...
    Segmentation_Dataset_1ch["Train"] += items_1ch[:n_train]
    Segmentation_Dataset_2ch["Train"] += items_2ch[:n_train]
    Segmentation_Dataset_3ch["Train"] += items_3ch[:n_train]

    Segmentation_Dataset_1ch["Validation"] += items_1ch[n_train:n_val]
    Segmentation_Dataset_2ch["Validation"] += items_2ch[n_train:n_val]
    Segmentation_Dataset_3ch["Validation"] += items_3ch[n_train:n_val]

    Segmentation_Dataset_1ch["Test"] += items_1ch[n_val:]
    Segmentation_Dataset_2ch["Test"] += items_2ch[n_val:]
    Segmentation_Dataset_3ch["Test"] += items_3ch[n_val:]
...
torch.save(Segmentation_Dataset_1ch, os.path.join(path, "fucci_dataset_1_channels.pth"))
torch.save(Segmentation_Dataset_2ch, os.path.join(path, "fucci_dataset_2_channels.pth"))
torch.save(Segmentation_Dataset_3ch, os.path.join(path, "fucci_dataset_3_channels.pth"))
