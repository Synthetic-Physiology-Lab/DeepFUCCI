...
crop_field = [4 * img_stream.dims.X // 10, 6 * img_stream.dims.X // 10]
...
cyan_layer.contrast_limits = (np.percentile(img_cyan, 70), np.percentile(img_cyan, 99.9))
magenta_layer.contrast_limits = (np.percentile(img_magenta, 70), np.percentile(img_magenta, 99.9))

cyan_layer_normalization = viewer.add_image(img_cyan, colormap="cyan", blending="additive")
magenta_layer_normalization = viewer.add_image(img_magenta, colormap="magenta", blending="additive")
cyan_layer_normalization.contrast_limits = (np.percentile(img_cyan, 1), np.percentile(img_cyan, 99.9))
magenta_layer_normalization.contrast_limits = (np.percentile(img_magenta, 1), np.percentile(img_magenta, 99.9))
...
add_bounding_boxes(masks, name="bboxes_confluent", color="red")
add_bounding_boxes(instanseg_labels, name="bboxes_instanseg", color="green")
...
cp_label_layer.contour = 4 
label_layer.contour = 4
label_layer_1ch.contour = 4
label_layer_2ch.contour = 4
