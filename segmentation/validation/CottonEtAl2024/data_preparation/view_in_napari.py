...
cyan_layer = viewer.add_image(img_cyan, colormap="cyan", blending="additive", name="cyan")
magenta_layer = viewer.add_image(img_magenta, colormap="magenta", blending="additive", name="magenta")
