...
training_data_dir = "training_data_tiled_binned_classified"
...
model_1d = StarDist2D(None, name="stardist", basedir="training_1_channels_stardist_binned/models")
model_2d = StarDist2D(None, name="stardist", basedir="training_2_channels_stardist_binned/models")
model_3d = StarDist2D(None, name="stardist", basedir="training_3_channels_stardist_binned/models")
...
for m in (
    ...
    plt.savefig(f"validation_binned_{m}.pdf")
    plt.show()
...
plt.savefig("validation_binned_label_numbers.pdf")
plt.show()
