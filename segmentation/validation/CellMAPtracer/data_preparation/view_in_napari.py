...
img_tub = img_stream.get_image_dask_data("TYX", S=int(channels["tubulin"]))
img_cyan = img_stream.get_image_dask_data("TYX", S=int(channels["cyan"]))
img_magenta = img_stream.get_image_dask_data("TYX", S=int(channels["magenta"]))
