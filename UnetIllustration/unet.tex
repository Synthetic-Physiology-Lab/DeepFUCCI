...
%\def\FinalColor{rgb:black,5}
\def\FinalColor{rgb:black,0.1; white, 10}
...
\def\CyanColor{rgb:cyan,1}
\def\MagentaColor{rgb:magenta,1}
\def\TubulinColor{rgb:black,4;white,8}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% input image
\node[canvas is zy plane at x=0] (temp) at (-3,0,0) {\includegraphics[width=8cm,height=8cm]{input_unet.png}};

\pic[shift={(0,0,0)}] at (0,0,0) {RightBandedBox={name=ch1,%
	,fill=\TubulinColor,bandfill=\TubulinColor,%
        height=40,width={1},depth=40}};
\pic[shift={(0,0,0)}] at (ch1-east) {RightBandedBox={name=ch2,%
        xlabel={{"",""}},fill=\MagentaColor,bandfill=\MagentaColor,%
        height=40,width={1},depth=40}};
\pic[shift={(0,0,0)}] at (ch2-east) {RightBandedBox={name=ch3,%
        fill=\CyanColor,bandfill=\CyanColor,%
        height=40,width={1},depth=40}};



% conv1_1,conv1_2
\pic[shift={(1,0,0)}] at (ch3-east) {RightBandedBox={name=cr1,%
...
\node[canvas is zy plane at x=0] (temp) at (35,0,0) {\includegraphics[width=8cm,height=8cm]{labels_drawing.png}};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Classifier 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\pic[shift={(0.75,0,0)}] at (ucr1a-east) {Box={name=out, fill=\FinalColor,height=40,width=0.1,depth=40}};

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Draw connections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\draw [connection]  (ch3-east)    -- node {\midarrow} (cr1-west);
